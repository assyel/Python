...
#17) (7 + 12)  3 + 7 * 4 - 44 / 2  4 расставить точки так чтобы получилось 6884.25. Вывести в консоль. Решение: Расставить знаки степени **, где пробелы, а количество пробелов 2
w = (7 + 12)**3 + 7 * 4 - 44 / 2**4
print('w =', w)
