...
ggg = item_1 < comp_item

if ggg:
    print('ggg Переменная item_1 меньше', comp_item)
else:
    print('ggg Переменная item_1 больше или равна', comp_item)
...
if item_2:
    print('lll Переменная item_2 = ', item_2)
else:
    print('lll Переменная item_2 = ', item_3)
...
if item_3:
    print('uuu Переменная item_3 = ', item_2)
else:
    print('uuu Переменная item_3 = ', item_3)
...
if item_5:
    print('ttt Переменная item_5 = ', item_5)
else:
    print('ttt Переменная item_5 = ', item_4)
...
if item_4:
    ...
    print('rrr Переменная item_4 = ', item_4)
...
if currency_convertor:
    print('www Переменная currency_convertor = ', item_3)
else:
...
#31. Внутри if currency_convertor сделать следующие If условия:
    ...
    if currency_convertor:
        ...
        print('target_currency = ', target_currency)
                    ...
                    #31.3 Создать переменную target_currency_amount со значением 50
    ...
    if target_currency == 'eur':
        ...
        print('chto ne pokazyvaet? =',  target_currency_amount, eur_item, '=', currency_result, usd_item)



                    #31.5 Сделать elif в котором будет условие: если target_currency равен ‘uah’,
        #то в теле этого if в значении переменной currency_result высчитать сколько долларов получится при target_currency_amount и
        #usd_uah_rate. Результат вывести в консоль(target_currency_amount, uah_item, “=”, currency_result, uah_item)
