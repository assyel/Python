...
#                     31.4.1 Сделать if в котором будет условие: если target_currency равен ‘eur’,
    ...
    if target_currency == 'eur':
        ...
        # usd_eur_rate = 0.86
        # target_currency_amount = 50
        print('31.4.1. target_currency_amount = 50, eur_item, “=”, currency_result, usd_item', target_currency_amount, usd_item, '=', currency_result, eur_item)
...
#                     Результат вывести в консоль (target_currency_amount, uah_item, “=”, currency_result, uah_item)
        ...
        print('31.5. target_currency_amount, usd_item, “=”, currency_result, uah_item', target_currency_amount, usd_item, '=', currency_result, uah_item)
...
#                     31.6 Сделать elif с остальными валютами
        ...
        print('31.6. chf', target_currency_amount, usd_item, '=', currency_result, chf_item)


    elif target_currency == 'rub':
        currency_result = target_currency_amount * usd_rub_rate
        print('31.6 rub', target_currency_amount, usd_item, '=', currency_result, rub_item)


    elif target_currency == 'byn':
        currency_result = target_currency_amount * usd_rub_rate
        print('31.6 byn', target_currency_amount, usd_item, '=', currency_result, byn_item)
